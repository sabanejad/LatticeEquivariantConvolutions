...
from load_for_simple_CNN import *
...
np.save("data/L"+str(L)+"_"+mystring+"_simple_CNN.npy",best_metrics)
torch.save(model['layers'].state_dict(), "data/L"+str(L)+"_"+mystring+"_simple_CNN.pt")
