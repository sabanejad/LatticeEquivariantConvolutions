...
# uses same parameters as simple CNN since they were found to be identical for L=6
HyperResults = np.load("data/L"+str(L)+"_hyper_simple_CNN.npy")
...
np.save("data/L"+str(L)+"_"+mystring+"_invariant_CNN.npy",best_metrics)
torch.save(model['layers'].state_dict(), "data/L"+str(L)+"_"+mystring+"_invariant_CNN.pt")
